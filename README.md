...
SSH allows secure connections to GitHub without typing passwords. Follow these steps to set it up.

### Step 1: Generate Your SSH Key
Open Terminal/Command Prompt (on Windows, use Git Bash that comes with Git) and run:

```
ssh-keygen -t ed25519 -C "your.email@example.com"
```

Press Enter for defaults, then Enter twice more (for no passphrase).

### Step 2: Add SSH Key to GitHub
1. Copy your public key (replace with your command based on OS):
   - Linux/Mac: `cat ~/.ssh/id_ed25519.pub`
   - Windows: `type %USERPROFILE%\.ssh\id_ed25519.pub`

2. Go to [GitHub SSH Keys Settings](https://github.com/settings/keys) → New SSH key.
3. Paste the copied key, title it "My Laptop", click Add.
...
### Step 4: Use SSH for Repositories
For your projects, use SSH URL: `git@github.com:your-username/my-repo.git`

Example to set remote for new repo:
```
